...
public class Home2 extends AppCompatActivity {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            if(node.equals("2H2")){
                                if(status.equals("1")){
                                    Room2_H2.fan_2.setImageResource(R.mipmap.fan_on);
                                    Room2_H2.fan_2_flag=true;
                                    ...
                                    Room2_H2.fan_2.setImageResource(R.mipmap.fan_off);
                                    Room2_H2.fan_2_flag=false;
                            ...
                            else if(node.equals("2H1")){
                                if(status.equals("1")){
                                    Room1_H2.led_2.setImageResource(R.mipmap.led_on);
                                    Room1_H2.led_2_flag=true;
                                    //History.myIconset.add(R.mipmap.led_on);
                                    //History.myDataset.add("LED 2");
                                    //History.mAdapter.notifyDataSetChanged();
                                }
                                else if(status.equals("0")){
                                    Room1_H2.led_2.setImageResource(R.mipmap.led_off);
                                    Room1_H2.led_2_flag=false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFragmentTransaction.replace(R.id.containerView,new TabFragment_H2()).commit();
        ...
        mNavigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                if (menuItem.getItemId() == R.id.logout) {
                    Intent intent = new Intent(Home2.this, Sign_In.class);
